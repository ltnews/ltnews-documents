...
A continuación se desgranarán cada una de las partes, componentes y fases que presenta SCRUM. Esta clasificación y explicación ha sido fruto del estudio del artículo de \citeA{scrum_altassian}.
...
\cuadro{llrrr}{Planificación de Sprints: duración}{tab:sprints_fechas}
{
...
\cuadro{llrrr}{Planificación de Sprints: horas}{tab:sprints_horas}
{
...
\cuadro{llr|rr}{Planificación temporal}{tab:planificacion}
{
    ...
    \textbf{2. Estudio} & & \textbf{30:00:00} & 50:00:00 & -66,67\% \\
     ...
     \textbf{6. Implementación} & & \textbf{100:00:00} & 109:59:4 & -9,99\% \\
