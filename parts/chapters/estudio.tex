...
Como se irá diciendo a lo largo del texto, las referencias han sido el propio libro, en cada uno de los apartados que se mencionan. A la vez, como un prisma genérico a un nivel de detalle menos acentuado, el artículo de \citeA{lean_emprendimiento}.
